...
public class AdminUserpageTest extends Basetest {
	...
	@Test(retryAnalyzer = retry.Retry.class, description = "Verify the AdminUserpage") // Retry
	public void enterUsernameAndPassword() throws IOException {
		...
		admin.moreinfo_And_Newbutton().enterUsernamePasswordUsertype(faker.getFakeFirstName(), faker.getPassword())
				.dropdown().savebutton();
		 ...
		 * adminuser.dropdown(); adminuser.savebutton();
		 */
	}
}
